 ...
 */
static int spacemit_k1_early_init(bool cold_boot, const void *fdt,
...
static int spacemit_hart_suspend(u32 suspend_type, ulong mmode_resume_addr)
{
 ...
 */
static int spacemit_k1_final_init(bool cold_boot, void *fdt,
                                  const struct fdt_match *match)
{
#ifdef CONFIG_ARM_PSCI_SUPPORT
